...
class Contract(models.Model):
    ...
    """
    database_nr = models.CharField(max_length=50, blank=True)
    contract_nr = models.CharField(max_length=50, blank=True)
    contract_status = models.CharField(max_length=50, blank=True)
    contract_name = models.CharField("Contract naam", max_length=250, blank=True)
    description = models.CharField("Beschrijving", max_length=250, blank=True)
    description_contract = models.CharField("Beschrijving contract", max_length=250, blank=True)
    category = models.CharField("Categorie", max_length=50, blank=True)

    contract_owner = models.CharField("Contracteigenaar", max_length=50, blank=True)
    contract_owner_email = models.CharField("Contracteigenaar email", max_length=50, blank=True)
    contract_owner_phone_nr = models.CharField("Contracteigenaar telnr", max_length=20, blank=True)
    ...
    manufacturer_address = models.CharField("Fabrikant Adres", max_length=250, blank=True)
    ...
    service_level_manager_2 = models.CharField(max_length=50, blank=True)
